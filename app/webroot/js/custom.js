                            ...
                            $.ajax
                              ({
                                 ...
                                 success:function(data)
                                 {
                                    ...
                                    $('.'+objs[0]).css("background-image","url("+encode('http://puzel.stage.n-framescorp.com/img/puzzel/"+get_name[0]+"/"+obj+"')+")");  //background:url('<?php echo $this->webroot;?>'img/puzzel/"+objs[0]+"/"+obj+"')");
