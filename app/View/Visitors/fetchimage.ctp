...
<?php 
    ...
    {?>
      ...
      .puzle-form .active, .button-puzzle:hover{background:#fff; color: #e58b16 !important;border:1px solid #e58b16 !important; box-shadow:none;}
          ...
          <div>
           <?php 
            ...
            foreach($image as $image_data)
              {
                  // Get Image path 
                $path =  $this->webroot.'/img/puzzel/'.str_replace(' ','',$PuzzleData['Puzzle']['name']).'/'.$image_data['name'] ;
