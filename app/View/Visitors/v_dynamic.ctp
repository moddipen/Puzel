  ...
  <div class="three columns">
      <div class="share-social">
          ...
          <br />
              <?php if(isset($Refrel))
              { ?>
                  <a class="share-btn" href="http://www.facebook.com/share.php?u=http://puzel.stage.n-framescorp.com/<?php echo $Company.'/'.$explode[4].'/'.substr($_SERVER['REQUEST_URI'], strrpos($_SERVER['REQUEST_URI'], '/') + 1);?>&title=<?php echo $PuzzleData['Puzzle']['name'];?>&description=http://puzel.stage.n-framescorp.com/img/puzzel/<?php echo $PuzzleData['Puzzle']['price_image'];?>" onclick="return !window.open(this.href, 'Facebook', 'width=640,height=580')"><i class="facebook">f</i></a>
              ...
              { ?>
                  <a class="share-btn" href="http://www.facebook.com/share.php?u=http://puzel.stage.n-framescorp.com/<?php echo $Company.'/'.substr($_SERVER['REQUEST_URI'], strrpos($_SERVER['REQUEST_URI'], '/') + 1);?>&title=<?php echo $PuzzleData['Puzzle']['name'];?>&description=http://puzel.stage.n-framescorp.com/img/puzzel/<?php echo $PuzzleData['Puzzle']['price_image'];?>" onclick="return !window.open(this.href, 'Facebook', 'width=640,height=580')"><i class="facebook">f</i></a>
