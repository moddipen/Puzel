                            ...
                            $.ajax
                              ({
                                 ...
                                 success:function(data)
                                 {
                                    ...
                                    javascript:successAlert("You have been enrolled. </br><?php if(isset($Refrel)) {?><a class='share-btn' href='http://www.facebook.com/share.php?u=http://puzel.stage.n-framescorp.com/<?php echo $Company.'/'.$explode[4].'/'.substr($_SERVER['REQUEST_URI'], strrpos($_SERVER['REQUEST_URI'], '/') + 1);?>&title=<?php echo $puzle_name;?>&description=Price 33$' onclick='return !window.open(this.href,Facebook,width=640,height=580)'><i class='facebook' style='color:black !important;top: 0px;'>f</i></a><a class='twitter-share-button' href='https://twitter.com/intent/tweet?text=http://puzel.stage.n-framescorp.com/<?php echo $Company.'/'.$explode[4].'/'.substr($_SERVER['REQUEST_URI'], strrpos($_SERVER['REQUEST_URI'], '/') + 1);?>' data-size='large' target ='_blank'><i class='twitter' style='color:black !important;top: 0px;'>l</i></a><a href='http://mail.live.com/default.aspx?rru=compose&to=&subject=Share new puzzle <?php echo $puzle_name;?>&body=http://puzel.stage.n-framescorp.com/<?php echo $Company.'/'.$explode[4].'/'.substr($_SERVER['REQUEST_URI'], strrpos($_SERVER['REQUEST_URI'], '/') + 1);?>' onclick='return !window.open(this.href,Outlook,width=640,height=580)' target='_blank'><i class='windows' style='color:black !important;font-size:60px !important;margin: 0 10px;'>w</i></a><a class='icon-gplus' href ='https://mail.google.com/mail/?view=cm&fs=1&to=&su=Share new puzzle <?php echo $puzle_name;?>&body=http://puzel.stage.n-framescorp.com/<?php echo $Company.'/'.$explode[4].'/'.substr($_SERVER['REQUEST_URI'], strrpos($_SERVER['REQUEST_URI'], '/') + 1);?>' onclick='return !window.open(this.href,Google,width=640,height=580)'><i class='email' style='color:black !important;font-size:60px !important;margin: 0 10px;'>m</i></a><?php } else {?><a class='share-btn' href='http://www.facebook.com/share.php?u=http://puzel.stage.n-framescorp.com/<?php echo $Company.'/'.substr($_SERVER['REQUEST_URI'], strrpos($_SERVER['REQUEST_URI'], '/') + 1);?>&title=<?php echo substr($_SERVER['REQUEST_URI'], strrpos($_SERVER['REQUEST_URI'], '/') + 1);?>&description=Price 33$' onclick ='return !window.open(this.href,Facebook,width=640,height=580)'><i class='facebook' style='color:black !important;top: 0px;'>f</i></a><a class='twitter-share-button' href='https://twitter.com/intent/tweet?text=http://puzel.stage.n-framescorp.com/<?php echo $Company.'/'.substr($_SERVER['REQUEST_URI'], strrpos($_SERVER['REQUEST_URI'], '/') + 1);?>' data-size='large' target = '_blank'><i class='twitter' style='color:black !important;top: 0px;'>l</i><a href='http://mail.live.com/default.aspx?rru=compose&to=&subject=Share new puzzle <?php echo $puzle_name;?>&body=http://puzel.stage.n-framescorp.com/<?php echo $Company.'/'.substr($_SERVER['REQUEST_URI'], strrpos($_SERVER['REQUEST_URI'], '/') + 1);?>' onclick='return !window.open(this.href,Outlook,width=640,height=580)' target='_blank'><i class='windows' style='color:black !important;font-size:60px !important;margin:0 10px;'>w</i></a><a class='icon-gplus' href ='https://mail.google.com/mail/?view=cm&fs=1&to=&su=Share new puzzle <?php echo $puzle_name;?>&body=http://puzel.stage.n-framescorp.com/<?php echo $Company.'/'.substr($_SERVER['REQUEST_URI'],strrpos($_SERVER['REQUEST_URI'], '/') + 1);?>' onclick='return !window.open(this.href,Google,width=640,height=580)'><i class='email' style='color:black !important;font-size:60px !important;margin: 0 10px;'>m</i></a><?php } ?>");
                                   }
                              });
                          }
                          else
