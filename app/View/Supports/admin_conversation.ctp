                  ...
                  <?php //debug($Conversation);?>
                    <div class="header">
                      ...
                      <div class="actions" style="padding: 0px 20px;">
                        ...
                        <button onclick="location.href='<?php echo Configure::read("SITE_ADMIN_URL")?>delete/<?php echo $Conversation[0]['Support']['random'];?>'" type="button" class="btn btn-default pull-right" style="margin-top: -53px;">
