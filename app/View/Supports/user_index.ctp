              ...
              <div class="col-lg-12 col-md-12">
                ...
                <section class="tile color transparent-black padding10px">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-2">
                      <div class="form-group">
                          <input type="button" value="Create Request" onClick="location.href='<?php echo Configure::read('SITE_USER_URL');?>/supports/add';" class="btn btn-oranges pull-right">
                        </div>
                    </div>
                  </div>
                                 ...
                                 <tr>
                                    ...
                                    <td><?php 
                                     ...
                                     <td>
                                      ...
                                      // echo "&nbsp; &nbsp;";
                                      echo $this->html->link( '',array('action' => 'conversation',$support['Support']['reply_id']),array('class'=>'fa fa-comments','style'=>"color:white;"));
                                      echo "&nbsp; &nbsp;";
