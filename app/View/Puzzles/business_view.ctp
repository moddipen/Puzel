                                  ...
                                  <div class="col-sm-8">
                                      <div class="form-group">
                                        ...
                                        <?php $company = str_replace(' ','', $Capturedata['Business']['company_name']);?>
                                          <input type="text" class="form-control" style="background-color:#fff;color:black;" value="<?php echo Configure::read("SITE_URL").$Capturedata['Business']['company_name']."/".$Capturedata['Puzzle']['random'];?>" id="puzlename">
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                      <div class="form-group">
