...
<div class="mc-field-group">
  ...
  <input type="password" value="" name="data[Subscription][password]" class="" id="mce-LNAME">
</div>
<div class="mc-field-group">
  <label for="mce-LNAME">Amount </label>
  <input type="text" value="<?php echo $Rate['Plan']['price'];?> $" name="data[Subscription][price]" disabled="disabled"  id="mce-LNAME">
</div>
<div class="mc-field-group">
  <label for="mce-LNAME">Card </label>
  <input type="text" value="" name="data[Subscription][card_number]" class="" id="mce-LNAME">
</div>
<div class="mc-field-group">
  <label for="mce-LNAME">Month </label>
  <input type="text" value="" name="data[Subscription][ex_date_month][month]" class="" id="mce-LNAME">
</div>
<div class="mc-field-group">
  <label for="mce-LNAME">Year </label>
  <input type="text" value="" name="data[Subscription][ex_date_year][year]" class="" id="mce-LNAME">
</div>

<div class="mc-field-group">
  <label for="mce-LNAME">CVV </label>
  <input type="text" value="" name="data[Subscription][cvv]" class="" id="mce-LNAME">
</div>
