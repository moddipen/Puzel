...
<div class="form-group">
    ...
    <?php } ?>
      <div id="mce-responses" class="clear">
        ...
        <div class="clear text-center" style="padding-bottom:30px;"><input type="submit" value="Signup" name="subscribe" id="mc-embedded-subscribe" class="btn btn-oranges"></div>
        </div>
      </section>
    </form>
