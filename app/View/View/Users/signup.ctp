...
<div class="row">
    ...
    <div class="twelve columns text-center fix-max-width">
      <a href="index.php"><img src="<?php echo $this->webroot;?>img/logo.png"></a>
        <h3 class="orange">Sign up to receive rewards from your favorite companies.<br>
...
<?php   echo $this->Form->create('User', array('action' => 'signup/'.$Type));?>
...
<div class="mc-field-group">
  ...
  <input type="email" value="" name="data[User][email]" class="required email" id="mce-EMAIL">
</div>
<div class="mc-field-group">
  <label for="mce-FNAME">First Name </label>
  <input type="text" value="" name="data[User][firstname]" class="" id="mce-FNAME">
</div>
<div class="mc-field-group">
  <label for="mce-LNAME">Last Name </label>
  <input type="text" value="" name="data[User][lastname]" class="" id="mce-LNAME">
</div>
