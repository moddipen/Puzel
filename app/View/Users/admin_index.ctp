                  ...
                  <div class="row">
                    ...
                    <div class="col-md-2">
                      <div class="form-group iconwithtext">
                          <a href="<?php echo Configure::read("SITE_ADMIN_URL");?>/users/export" id="userdownload">
  ...
  $( document ).delegate( "input[type='checkbox']", "click", function() 
    {
      ...
      if (this.checked)
      {
        $.ajax(
        {
          url: "<?php echo Configure::read('SITE_ADMIN_URL')?>/users/useractive/"+this.value,
          type: "post",
          datatype:"json",
          data: {'id':this.value} ,
      ...
      else
      {
        $.ajax(
        {
          url: "<?php echo Configure::read('SITE_ADMIN_URL')?>/users/userdeactive/"+this.value,
          type: "post",
          datatype:"json",
          data: {'id':this.value} ,
          success: function (data)
...
//////////////////////////// Filter module -----------------------------------------------
  ...
  $("#status").change(function()
  {
    ...
    {
      type: "POST",
      url: "<?php echo Configure::read('SITE_ADMIN_URL')?>/users/status",
      data: {'status':status},
      success: function(data)
      {
        $("#content1").html(data);
