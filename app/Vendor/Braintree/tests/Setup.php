...
class Setup extends PHPUnit_Framework_TestCase
{
    ...
    public static function integrationMerchantConfig()
    {
        ...
        Configuration::merchantId(Configuration::read('BraintreeMerchan'));
        Configuration::publicKey(Configuration::read('BraintreePublicKey'));
        Configuration::privateKey(Configuration::read('BraintreePrivateKey'));
    }
}
