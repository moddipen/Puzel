...
class Helper
{
    ...
    public static function testMerchantConfig()
    {
        ...
        Braintree\Configuration::merchantId(Configure::read('BraintreeMerchan'));
        Braintree\Configuration::publicKey(Configure::read('BraintreePublicKey'));
        Braintree\Configuration::privateKey(Configure::read('BraintreePrivateKey'));
    }
    ...
    public static function createViaTr($regularParams, $trParams)
    {
        $trData = Braintree\TransparentRedirect::transactionData(
            array_merge($trParams, ["redirectUrl" => Configure::read('SITE_URL')])
        );
